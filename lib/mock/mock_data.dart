...
class MockData {
  ...
  /// 模拟上海市内一段行程路径（外滩 → 豫园）
  static const List<Map<String, double>> mockRoutePoints = [
    {"lat": 31.2421, "lng": 121.4971}, // 外滩
    {"lat": 31.2415, "lng": 121.4920}, // 南京东路
    {"lat": 31.2408, "lng": 121.4870}, // 南京西路
    {"lat": 31.2390, "lng": 121.4840}, // 人民广场
    {"lat": 31.2335, "lng": 121.4820}, // 淮海中路
    {"lat": 31.2310, "lng": 121.4785}, // 新天地
    {"lat": 31.2280, "lng": 121.4755}, // 马当路
    {"lat": 31.2270, "lng": 121.4900}, // 豫园
  ];

  /// 拿到 LatLng 格式的 mock 轨迹点列表
  static List<dynamic> get mockRouteLatLngs =>
      mockRoutePoints.map((p) => {"lat": p["lat"], "lng": p["lng"]}).toList();
